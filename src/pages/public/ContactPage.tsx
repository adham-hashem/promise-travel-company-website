  ...
  const contacts = [
    {
      ...
      title: 'أرقام الهاتف',
      items: [
        { label: 'الخط الأول', value: '0100 123 4567' },
        { label: 'الخط الثاني', value: '0101 234 5678' },
      ],
    },
    {
      icon: MessageCircle,
      title: 'واتساب',
      items: [{ label: 'تواصل فوري', value: '0100 123 4567' }],
    },
    {
      icon: Mail,
  ...
  return (
    <div>
      ...
      <section className="relative h-[40vh] min-h-[300px] overflow-hidden">
        <img src="https://images.pexels.com/photos/7658369/pexels-photo-7658369.jpeg?auto=compress&cs=tinysrgb&w=1920" alt="تواصل معنا" className="w-full h-full object-cover" />
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-emerald-950 mt-2">طرق التواصل المتاحة</h2>
            ...
            {contacts.map((c) => {
              ...
              return (
                <div key={c.title} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all text-center">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-emerald flex items-center justify-center text-gold-400 mx-auto mb-4">
                    <Icon size={26} />
                  </div>
                  <h3 className="font-black text-emerald-950 text-lg mb-4">{c.title}</h3>
                  <div className="space-y-2">
                    {c.items.map((it) => (
                      <div key={it.value}>
                        <p className="text-xs text-gray-400">{it.label}</p>
                        <p className="text-emerald-800 font-bold text-sm" dir="ltr">{it.value}</p>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-emerald rounded-3xl p-7 text-white">
            ...
            <div className="bg-white rounded-3xl p-7 shadow-sm border border-gray-100">
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 rounded-2xl bg-gradient-gold flex items-center justify-center text-emerald-950 flex-shrink-0">
                  <Clock size={24} />
                </div>
                <div>
                  <h3 className="font-black text-emerald-950 text-lg mb-2">ساعات العمل</h3>
                  <div className="space-y-1 text-sm text-gray-600">
                    <p>السبت — الخميس: <span className="font-bold text-emerald-800">9 صباحاً — 9 مساءً</span></p>
                    <p>الجمعة: <span className="font-bold text-emerald-800">2 ظهراً — 9 مساءً</span></p>
                  </div>
                </div>
              </div>
            </div>
