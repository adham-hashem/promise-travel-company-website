...
import {
  ...
  CheckCircle2, Sparkles, Plane as PlaneIcon, Compass, Users2,
} from 'lucide-react';
  ...
  return (
    <div className={`group rounded-3xl overflow-hidden shadow-lg transition-all hover:scale-[1.02] ${dark ? 'bg-white' : 'public-card'}`}>
      <div className="relative h-52 overflow-hidden">
        ...
        <div className="absolute top-3 left-3" onClick={(e) => e.stopPropagation()}><ShareButton title={p.name} compact /></div>
      </div>
      <div className="p-5">
